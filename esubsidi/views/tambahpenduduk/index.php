...
<div class="container">
    <div class="row">
        <div class="col-lg-8 mx-auto position-relative">
            <div class="container">
                <h1 class="display-5 text-center fw-bold mb-3 ">Tambah Data Penerima Subsidi</h1>
                <hr>
                ...
                <form action="<?= BASEURL ?>/tambahpenduduk/tambahdata" method="POST" class="row g-3 mx-auto">
                    ...
                    <div class="col-6">
                        ...
                        <input required class="form-control input-groupinput-group-addon" id="rt" name="rt" <?= $data['disabled'] ?> autocomplete="off" placeholder="RT" value='<?= $data['rtVal'] ?>' type="number" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="3" min="1" />
                    </div>
                    <div class="col-6">
                        <label for="rw" class="form-label fw-bold">RW</label>
                        <input required class="form-control input-groupinput-group-addon" value='<?= $data['rwVal'] ?>' id="rw" name="rw" <?= $data['disabled'] ?> autocomplete="off" placeholder="RW" type="number" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="3" min="1" />
                    </div>
                    <div class="col-lg-6 ">
