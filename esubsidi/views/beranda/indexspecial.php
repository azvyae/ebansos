                ...
                <div class="row">
                    <div class="col col-md-6 mx-auto">
                        <form action="<?= BASEURL ?>/beranda/cekdata" method="POST">
                            ...
                            <div class="mx-auto">
                                <button type="submit" id='periksaData' class="checkButton btn mx-auto my-3 w-100 btn-primary btn-lg btn-ripple">Periksa Data</button>
                            </div>
                            <div class="mx-auto">
                                <button type="submit" id='tambahSubsidi' class="checkButton btn mx-auto my-3 w-100 btn-warning btn-lg btn-ripple">Tambahkan Subsidi</button>
                            </div>
                        </form>
