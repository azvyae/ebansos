...
<script>
    document.addEventListener("DOMContentLoaded", function(event) {
        $('input[value="<?= $penduduk['jenisKelamin'] ?>"]').prop("checked", true);
        $('input[value="<?= $penduduk['statusPerkawinan'] ?>"]').prop("checked", true);
    })
</script>
<div class="container">
    <div class="row">
        <div class="col-lg-8 col mx-auto position-relative">
            <div class="container">
                <h1 class="display-5 text-center fw-bold mb-3 ">Ubah Data Penerima Bansos</h1>
                <hr>
                ...
                <form action="<?= BASEURL ?>/ubahpenduduk/ubahdata/<?= $data['hashId'] ?>" method="POST" class="row g-3 mx-auto">
                    ...
                    <div class="col-lg-6 mt-1">
                        ...
                        <input type="text" pattern="[0-9]+" title="Masukkan hanya angka" value="<?= $penduduk['nik'] ?>" autocomplete="off" class="form-control" id="nik" name='nik' placeholder="3273000011110000" minlength="16" maxlength="16" required>
                    </div>
                    <div class="col-lg-6 mt-1">
                        <label for="nama" class="form-label fw-bold">Nama</label>
                        <input type="text" autocomplete="off" class="form-control" value="<?= $penduduk['nama'] ?>" id="nama" name='nama' required>
                    </div>
                    ...
                    <div class="mt-1 col-lg-12">
                        ...
                        <input type="text" autocomplete="off" class="form-control" value="<?= $penduduk['tempatLahir'] ?>" id="tempatLahir" name='tempatLahir' required>
                    </div>
                    <div class="col-4">
                        <label for="hari" class="form-label fw-bold">Tanggal</label>
                        <input required class="form-control input-groupinput-group-addon" value="<?= $penduduk['hari'] ?>" id="hari" name="hari" autocomplete="off" placeholder="HH" type="number" oninput="this.value=this.value.slice(0,this.maxLength)" maxlength="2" max="31" min="1" />
                    </div>
                    <div class="col-4">
                        <label for="bulan" class="form-label fw-bold">Bulan</label>
                        <input required class="form-control input-groupinput-group-addon" value="<?= $penduduk['bulan'] ?>" id="bulan" name="bulan" autocomplete="off" placeholder="BB" maxlength="2" max="12" min="1" type="number" oninput="this.value=this.value.slice(0,this.maxLength)" />
                    </div>
                    <div class="col-4">
                        <label for="tahun" class="form-label fw-bold">Tahun</label>
                        <input required class="form-control input-groupinput-group-addon" value="<?= $penduduk['tahun'] ?>" id="tahun" name="tahun" autocomplete="off" placeholder="TTTT" oninput="this.value=this.value.slice(0,this.maxLength)" min="1900" max="<?= date("Y"); ?>" maxlength="4" type="number" />
                    </div>
                    ...
                    <div class="col-lg-6 mt-1">
                        ...
                        <textarea rows="3" style="resize: none;" required class="form-control input-groupinput-group-addon" id="alamatRumah" name="alamatRumah" autocomplete="off" placeholder="Isi sesuai alamat tinggal saat ini"><?= $penduduk['alamatRumah'] ?></textarea>
                    </div>
                    ...
                    <div class="col-lg-6 ">
                        ...
                        <input required class="form-control input-groupinput-group-addon" value='<?= $penduduk['pekerjaan'] ?>' id="pekerjaan" name="pekerjaan" autocomplete="off" placeholder="Pekerjaan" type="text" />
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12 d-flex justify-content-end">
                        ...
                        <input class="ms-4  btn btn-success w-50" type="submit" value="Ubah">
                    </div>
