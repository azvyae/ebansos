    ...
    <div class="row px-5">
        <form action="<?= BASEURL ?>/beranda/cekdata" class='col-md-6 mx-auto' method="POST">
            ...
            <div class="my-3 row">
                ...
                <div class="col-5 mb-3 position-relative">
            ...
            <div class="mx-auto">
                <button type="submit" id='tambahBansos' class="position-relative checkButton btn mx-auto my-3 w-100 btn-warning btn-lg btn-ripple">Tambahkan Bansos</button>
            </div>
        </form>
        <?php Flasher::flash(); ?>
    </div>
